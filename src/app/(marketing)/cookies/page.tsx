...
export default function CookiesPage() {
  return (
    <main className="mx-auto w-full max-w-3xl px-5 py-16 sm:px-8">
      ...
      <div className="mt-8 grid gap-6 leading-relaxed text-mist-300">
        <section>
        ...
        <section>
          ...
          <p className="mt-2">
            A contagem de visitas e cliques é <strong>first-party e sem
            cookies</strong>: registramos o evento sem identificador persistente
            e sem rastrear a pessoa entre sites. Por isso ela funciona mesmo
            quando o visitante recusa cookies opcionais.
          </p>
          <p className="mt-3">
            Se o dono da página conectar ferramentas de terceiros (Meta Pixel ou
            Google Analytics), esses scripts <strong>só são carregados depois do
            aceite explícito</strong> do visitante. Antes da escolha, eles ficam
            desligados; recusar é tão fácil quanto aceitar, no mesmo aviso.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            recusa de cookies. Dados enviados em formulários pertencem ao dono da
            página e nunca entram na medição agregada.
          </p>
        </section>
      </div>
    </main>
