      ...
      <div className="mt-8 grid gap-5 leading-relaxed text-ink-600">
        <p>
          <strong className="text-ink-900">
            O que coletamos de você (cliente Decola):
          </strong>{" "}
        ...
        <p>
          <strong className="text-ink-900">
            O que as suas páginas coletam dos visitantes:
          </strong>{" "}
        ...
        <p>
          <strong className="text-ink-900">Provedores:</strong> a operação usa
        ...
        <p>
          <strong className="text-ink-900">Seus direitos:</strong> você pode
